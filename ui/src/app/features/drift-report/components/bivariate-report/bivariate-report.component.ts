...
@Component({
  selector: 'drift-bivariate-report',
  ...
  handleHoverItem(d: HeatmapData): void {
    ...
    if (d) {
      ...
      this.tooltip = {
        ...
        yValue: d.y,
        productionValue:
          this.bivariateReport.production_heatmap.density[yIndex][xIndex],
        trainingValue:
          this.bivariateReport.training_heatmap.density[yIndex][xIndex],
        top: offsetY + 12,
        left: offsetX + 12,
      };
    } else {
