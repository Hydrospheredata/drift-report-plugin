...
from drift_report.config import SIGNIFICANCE_LEVEL
...
class StatisticalTest:
    ...
    def process(self, training_data, production_data):
        ...
        try:
            test_statistic, test_p = self.statistic_test_func(
                training_data, production_data, **self.statistic_test_func_kwargs
            )[:2]
